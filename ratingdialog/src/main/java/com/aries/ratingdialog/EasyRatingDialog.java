...
public class EasyRatingDialog {
  ...
  private android.app.Dialog createDialog(Context context) {
    ...
    RatingDailog ratingDailog = new RatingDailog(context, new RatingDailog.RatingDialogListener() {
      @Override
    ...
    return ratingDailog.setTitle(context.getString(R.string.erd_title))
                ...
                .setReminderMeLaterButtonText(context.getString(R.string.erd_remind_me_later));
  }
}
